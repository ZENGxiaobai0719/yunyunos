  ...
  <div class="common-layout">
    <el-container>
      <el-header height="54px" style="padding: 0">
        <div class="header">
          <div @click="toMySpace" class="logo">短链接平台</div>
          <div style="display: flex; align-items: center">
            <el-dropdown>
              <div class="block">
                <el-icon class="user-icon" :size="22"><UserFilled /></el-icon>
              </div>
              <template #dropdown>
                <el-dropdown-menu>
                  <el-dropdown-item>
                    <span style="color: #8888AA; font-size: 12px">{{ username }}</span>
                  </el-dropdown-item>
                  <el-dropdown-item divided @click="toMine">个人信息</el-dropdown-item>
