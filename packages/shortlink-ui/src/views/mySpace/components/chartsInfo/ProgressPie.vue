<template>
  <div class="main-box">
    <el-progress color="#00EEA6" type="circle" :stroke-width="10" :percentage="data1Precentage">
      <template #default>
        <div class="flex-box">
    ...
    <el-progress color="#00EEA6" type="circle" :stroke-width="10" :percentage="data2Precentage">
      <template #default>
        <div class="flex-box">
