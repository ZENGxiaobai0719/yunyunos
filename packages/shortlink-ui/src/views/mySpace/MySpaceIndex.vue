  ...
  <div style="display: flex; height: 100%">
    <div class="options-box">
      <div class="option-title flex-box">
        <div>
          <el-icon style="margin-right: 4px; vertical-align: middle"><Folder /></el-icon>短链分组<span> 共{{ editableTabs?.length }}组</span>
        </div>
    ...
    <div class="content-box">
      <div class="table-box">
        ...
        <div v-if="!isRecycleBin" class="buttons-box">
          <div style="width: 100%; display: flex">
            ...
            <el-button class="addButton" type="primary" style="width: 130px; margin-right: 10px"
              @click="isAddSmallLink = true"><el-icon style="margin-right: 4px"><Plus /></el-icon>创建短链</el-button>
            <el-button style="width: 130px; margin-right: 10px" @click="isAddSmallLinks = true"><el-icon style="margin-right: 4px"><DocumentAdd /></el-icon>批量创建</el-button>
          </div>
        </div>
        <!-- 展示回收站信息 -->
        ...
        <el-table :data="tableData" height="calc(100vh - 240px)" style="width: calc(100vw - 230px)"
          :header-cell-style="{ background: '#1A1A2A', color: '#8888AA' }">
          <!-- 数据为空时展示的内容 -->
          <template #empty>
